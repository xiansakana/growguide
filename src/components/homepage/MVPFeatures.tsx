  ...
  return (
    <div className="bg-[#FDF8F3] flex flex-col justify-center items-center gap-y-4 p-12 my-8 ">
      ...
      <span className="text-black text-sm md:px-8 lg:px-16 text-center">
        ...
        operations, with direct links to Alibaba, Amazon, Home Depot, and Lowes.
        Enhance your visibility, grow your client base, and benefit from our
        rewarding affiliate program. Register as a professional and thrive with
        us. Join now for endless opportunities and success in the green
        industry!
      </span>
      ...
      <span className="text-black text-sm md:px-8 lg:px-16 text-center">
        This comprehensive digital encyclopedia offers detailed guides on the 40
        most commonly gardened crops in the U.S. Dive into a wealth of
        information covering hardiness zones, optimal seeding times, proper
        planting techniques, and much more. Whether it's sun/shade requirements,
        watering schedules, companion planting, or exploring medicinal benefits,
        our Species Guide is your go-to resource for cultivating your garden
      ...
      <span className="text-black text-sm md:px-8 lg:px-16 text-center">
        ...
        conversational AI assistant. Designed to extend the capabilities of our
        codex, this smart assistant is ready to tackle all your gardening
        inquiries. From the nuances of plant care to advanced horticultural
        advice, get accurate, detailed answers instantly. Whether you're a
        seasoned gardener or just starting, our AI Chatbot is here to support
        your horticultural journey every step of the way.
      </span>
      <button className="mt-6 px-8 py-3 bg-orange-500 text-white rounded-lg shadow-xl hover:bg-green-600 transition-colors ">
