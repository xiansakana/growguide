const Hero = () => {
  return (
    <div className="relative h-full w-full top-0 left-0">
      ...
      >
        <div className="font-bold text-left text-black text-[12px] sm:text-xl md:text-2xl lg:text-5xl flex flex-col gap-y-2">
          <span className="text-base text-green-700">WELCOME TO GROWGUIDE</span>
        ...
        <div className="flex md:flex-row flex-col flex-wrap md:gap-4 gap-1">
          <button className="flex mt-1 px-1 sm:px-4 md:px-8 lg:px-16 py-1 sm:py-2 lg:py-4 bg-orange-500 text-white rounded-lg shadow-xl hover:bg-green-600 transition-colors ">
